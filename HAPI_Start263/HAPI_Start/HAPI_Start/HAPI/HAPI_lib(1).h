...
For full details on using the library please see the reference documentation avaialble in the HAPI/Reference folder.

Last modified by Keith Ditchburn: February 2023
